...
- (id)init
{
    /*CGFloat scalingFactor = 1;
    if(_image!=NULL){
        scalingFactor=_image.size.width/_image.size.height;
    }*/
    
    return [self initWithFrame:CGRectMake(60, 80, 200.f, 200.f)];
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    //CGContextRotateCTM(shineMaskContextRef, 0.f);
